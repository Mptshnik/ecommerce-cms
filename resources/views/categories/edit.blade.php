...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Изменение категории</h4>
                    </div><!--end col-->
                </div><!--end row-->
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="add-category-form" method="POST" action="{{route('categories.update', $category)}}">
                @csrf
                @method('PATCH')
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" @if($category->visible_in_menu) checked
                        ...
                        <div class="card report-card">
                            ...
                            <div class="card-body">
                                ...
                                <textarea class="form-control"
                                          name="description"
                                          rows="3">{{$category->getKeyValueFromDescription('description')}}</textarea>
                            </div><!--end card-body-->
                        </div><!--end card-->
                    </div> <!--end col-->
                    <div class="col-lg-6">
                                    ...
                                    <ul style="list-style-type: none">
                                        <li>
                                            <div class="radio radio-primary">
                                                ...
                                                <input @if($category->category_id == $rootCategory->id) checked
                                                       @endif type="radio" name="category_id"
