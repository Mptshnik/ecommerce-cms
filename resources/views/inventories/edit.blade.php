...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Изменение склада</h4>
                    </div><!--end col-->
                </div><!--end row-->
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="add-inventory-form" method="POST" action="{{route('inventories.update', $inventory)}}"
                  class="mb-3">
                @csrf
                @method('PATCH')
                        ...
                        <div class="card report-card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{$inventory->name}}" name="name" class="form-control"
                                           placeholder="Название">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Код<span class="text-danger"> *</span></label>
                                    <input type="text" value="{{$inventory->code}}" name="code" class="form-control"
                                           placeholder="Код">
                                </div>
                                <div>
                                    <label class="form-label">Статус</label>
                                    <div class="form-check form-switch">
                                        <input @if($inventory->status) checked @endif class="form-check-input"
                        ...
                        <div class="card report-card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{$inventory->contact_information['full_name'] ?? ''}}"
                                           name="full_name" class="form-control"
                                           placeholder="Иванов Иван Иванович">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Email<span class="text-danger"> *</span></label>
                                    <input type="email" value="{{$inventory->contact_information['email'] ?? ''}}"
                                           name=email class="form-control"
                                           placeholder="email@mail.ru">
                                </div>
                                <div>
                                    <label class="form-label">Номер телефона<span class="text-danger"> *</span></label>
                                    <input type="text" value="{{$inventory->contact_information['phone_number'] ?? ''}}"
